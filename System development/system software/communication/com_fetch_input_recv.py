...
def com_fetch_input_recv(fetch_input_receive, fetch_input_receive_lock, pipeline_ready, pipeline_ready_lock):
    ...
    while True:
        ...
        while len(fetch_input_receive) > 0:
            pass
        with fetch_input_receive_lock:
            fetch_input_receive.append(valid_input)
